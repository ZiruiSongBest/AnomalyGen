...
user_contents = [
"""
A robotic arm is trying to solve dangerous or unsanitary household anomalies
...
In the substep, please try to use simple actions that the robotic arm is capable of performing.
